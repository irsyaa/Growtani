          ...
          <div class="row">
            <div class="col-lg-6 align-self-center">
              <div class="left-content header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                <h6>Welcome to Growtani</h6>
                <h2>Kami membuat <em>Petani</em>  <span>Bisa </span>Membuat Usaha</h2>
                <p>Growtani adalah platform yang dibuat untuk petani yang membutuhkan bahan bahan pertanian seperti pupuk,bibit sampai tanah dengan system urun dana
                  Keuntungan akan dibagi sesuai perjanjian antara pemberi dana dan penerima dana</p>
          ...
          <a href="#">
            <div class="item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.3s">
              <div class="hidden-content">
                <h4>Pendana ( Lender )</h4>
                <p>Danailah usaha dan raih keuntungan darinya , mulai dari 100k</p>
              </div>
              <div class="showed-content">
                <img src="assets/images/Investor.jpg" alt="">
              </div>
            </div>
          </a>
        </div>
        ...
        <div class="col-lg-6 col-sm-8">
          <a href="#">
            <div class="item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.6s">
              <div class="hidden-content">
                <h4>Penerima dana ( Borrower )</h4>
                <p>Mulailah Usaha Pertanian Anda dengan keuntungan sebesar-besarnya</p>
              </div>
              <div class="showed-content">
                <img src="assets/images/petani.jpg" alt="">
              </div>
            </div>
          </a>
        </div>
